import argparse, os
from GT2SaveEditor import GT2SaveEditor
...
def readArgs():
    ...
    parser.add_argument("-lang", action = "store", help = "set language", choices = list(GT2SaveEditor.LANGUAGES.keys()))
    parser.add_argument("-arc", action = "store", help = "set arcade progress", choices = list(GT2SaveEditor.ARCADE_PROGRESS.keys()))
    parser.add_argument("-car", action = "store", help = "set career progress", choices = list(GT2SaveEditor.CAREER_PROGRESS.keys()))
    parser.add_argument("-lic", action = "store", help = "set career license progress", choices = list(GT2SaveEditor.LICENSE_PROGRESS.keys()))
